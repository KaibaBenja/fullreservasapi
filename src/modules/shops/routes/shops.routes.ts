...
import { shopsSchema, filterShopSchema, filterShopSchemaUser, createShopSchema } from "../schemas/shops.schema";

export const shopRoutes = express.Router();

shopRoutes.post("/", validateSchema(createShopSchema), shopsController.create);
